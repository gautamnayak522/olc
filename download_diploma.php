<!--delete material form-->
	<form action="material2.php" method="post" id="form3">
 ...
 <!--<input type="submit" value="Submit" name="SubmitData"/>-->
										...
										<div>
										<button id="payment-button" type="submit" name="download_diploma" class="btn btn-lg btn-info btn-block">
...
<!--delete material-->
	<?php
	if(isset($_POST['download_diploma']))
	{
		if(isset($_POST["material3"]))	
		{
			$b= $_POST["material3"];
			//echo "<a href='upload/$b' download>".$_POST['material']."</a>";
			echo "<a href='../olcadminfinal/diploma_upload/$b' download>".$_POST['material3']."</a>";
		}
	}
?>
	<!--end delete material-->
