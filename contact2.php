					...
					<form method="POST">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea id="message" name="msg" cols="30" rows="10" class="form-control" placeholder="Say something about us"></textarea>
							</div>
						</div>
						<div class="form-group">
							<input type="submit" name="send_msg" value="Send Message" class="btn btn-primary">
						</div>
...
if(isset($_POST["send_msg"]))
{
	...
	$ins="insert into contact_us (fname,lname,email,sub_of_msg,msg)values('$fnm','$lnm','$e','$s','$m');";
	
	if(mysqli_query($c,$ins))
	{
		echo "<script>alert('your message is sucessfully sent');</script>";
	}
	else
	{
		echo mysqli_error($c);
