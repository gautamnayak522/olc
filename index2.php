	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				...
				<div id="fh5co-logo"><a href="index2.php">ONLINE LEARNING CENTER</a></div>
					<div class="col-xs-1">
					...
					<div class="col-xs-11 text-right menu-1">
					 <a href="#" class="active"> <?php include 'checklogin.php'?></a>
						<ul>
							...
							<li><a href="material2.php">Material</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 text-center animate-box">
					...
					<span class="fh5co-counter-label">Material</span>
				</div>
			</div>
		</div>
	</div>
...
-->
	...
	<div id="fh5co-started" style="background-image:url(images/img_bg_2.jpg);">
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="courses.php" class="btn btn-default btn-lg">Start Course</a></p>
				</div>
			</div>
		</div>
	</div>
