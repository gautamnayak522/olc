	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				...
				<div id="fh5co-logo"><a href="index.php">ONLINE LEARNING CENTER</a></div>
					<div class="col-xs-1">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>"Online learning is not the next big thing, it is the now big thing."</h1>
							<p><a class="btn btn-primary btn-lg btn-learn" href="courses.php">Take A Course</a>
							<a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://youtu.be/nzV1NmhC7ik">
							<i class="icon-play"></i> Watch Video</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center animate-box">
					<span class="fh5co-counter js-counter" data-from="0" data-to="7800" data-speed="5000" data-refresh-interval="50"></span>
...
-->
			<div class="row bs-wizard animate-box" style="border-bottom:0;">
				...
				<div class="col-xs-3 bs-wizard-step complete">
					...
					<div class="bs-wizard-info text-center"><p>Start Course</p></div>
				</div>
				...
				<div class="col-xs-3 bs-wizard-step active"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="bs-wizard-info text-center"><p>Complete Course</p></div>
				</div>
				...
				<div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
					...
					<div class="progress"><div class="progress-bar"></div></div>
					<a href="#" class="bs-wizard-dot"></a>
					<div class="bs-wizard-info text-center"><p> Give Exam</p></div>
				</div>
...
-->
	...
	<div id="fh5co-started" style="background-image:url(images/img_bg_2.jpg);">
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p><a href="#" class="btn btn-default btn-lg">Start Course</a></p>
				</div>
			</div>
		</div>
	</div>
