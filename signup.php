...
<html>
	...
	<title>Sign Up-Online Learning Center</title>
	<meta charset="UTF-8">
...
<!-- Meta tag Keywords --
<!-- css files --
<link href="signup/css/style.css" rel="stylesheet" type="text/css" media="all">
<link href="signup/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
<!-- //css files -->
<!-- online-fonts -
<link href='//fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'><link href='//fonts.googleapis.com/css?family=Raleway+Dots' rel='stylesheet' type='text/css'>
	
	<!--end head of signupindex-->
			...
			<div class="wrap-login100 p-t-0 p-b-20">
				<form class="login100-form validate-form"  method="post">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter First Name">
						<input class="input100" type="text" name="fname" autocomplete="off" autofocus>
						<span class="focus-input100" data-placeholder="First Name"></span>
					</div>
					
					
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Last Name">
						<input class="input100" type="text" name="lname" autocomplete="off">
						<span class="focus-input100" data-placeholder="Last Name"></span>
					</div>


					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter Phone Number">
						<input class="input100" type="text" pattern="[6789][0-9]{9}" name="pno" autocomplete="off">
					...
					<div class="container-login100-form-btn">
						<input type="submit" class="login100-form-btn" name="sup">
					</div>
	...
	if($c)
	{
		if(mysqli_select_db($c,"olc"))
		{
			...
			if(isset($_POST["sup"]))
			{
				...
				$ps=$_POST["pass1"];
				$cp=$_POST["pass2"];
		$ins= "insert into registration values('$f','$l',$p,'$e','$ps')";
